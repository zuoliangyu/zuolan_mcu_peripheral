...
sx1262: SCK connected to GPIO11(BCM).
sx1262: MISO connected to GPIO9(BCM).
sx1262: MOSI connected to GPIO10(BCM).
sx1262: CS connected to GPIO8(BCM).
sx1262: RESET connected to GPIO27(BCM).
sx1262: DIO1 connected to GPIO22(BCM).
sx1262: BUSY connected to GPIO17(BCM).
```
...
sx1262: irq rx done.
sx1262: rssi is -107.0.
sx1262: snr is 2.75.
sx1262: signal rssi is -109.0.
