...
LibDriver AGS10是LibDriver推出的AGS10全功能驱动，该驱动提供TVOC读取等功能并且它符合MISRA标准。
...
/src目录包含了LibDriver AGS10的源文件。

/interface目录包含了LibDriver AGS10与平台无关的IIC总线模板。

/test目录包含了LibDriver AGS10驱动测试程序，该程序可以简单的测试芯片必要功能。

/example目录包含了LibDriver AGS10编程范例。

/doc目录包含了LibDriver AGS10离线文档。

/datasheet目录包含了AGS10数据手册。
...
在线文档: [https://www.libdriver.com/docs/ags10/index.html](https://www.libdriver.com/docs/ags10/index.html)。
