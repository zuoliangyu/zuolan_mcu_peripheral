...
| 10.2      | Expressions of essentially character type shall not be used     inappropriately in addition and subtraction operations. | incompatible | We use this function to convert driver settings. Developers need to refer to the data manual to convert settings. | very low |
...
| 10.8      | The value of a composite expression shall not be cast to a different essential type category or a wider essential type. | incompatible | We use this function to convert driver settings. Developers need to refer to the data manual to convert settings. | very low |

### Report

Detailed reports can be found in /misra/ssd1315_polyspace_report.pdf.
